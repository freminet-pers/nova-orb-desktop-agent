...
STATE_RULES.update({
    ...
    'thinking': SceneRule(84, interruptible=False, recovery='idle'),
    'searching': SceneRule(80, interruptible=False, recovery='idle'),
    'working': SceneRule(80, interruptible=False, recovery='idle'),
    ...
    'loading': SceneRule(86, interruptible=False, recovery='idle'),
    'dictating': SceneRule(90, interruptible=False, recovery='idle'),
    'writing': SceneRule(84, interruptible=False, recovery='idle'),
    'sending': SceneRule(84, interruptible=False, recovery='idle'),
    'receiving': SceneRule(70, recovery='idle'),
    'uploading': SceneRule(60, recovery='idle'),
    'notifying': SceneRule(60, recovery='idle'),
    'alerting': SceneRule(98, interruptible=False, recovery='idle'),
    'dragging': SceneRule(82, interruptible=False, recovery='idle'),
...
SCENE_RULES = {
    ...
    'reply': SceneRule(72, recovery='idle'),
    'saved': SceneRule(72, recovery='idle'),
    'launched': SceneRule(72, recovery='idle'),
    'error': SceneRule(99, interruptible=False, recovery='idle'),
}
